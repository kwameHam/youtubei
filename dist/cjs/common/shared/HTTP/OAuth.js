...
class OAuth {
    static async authorize() {
        ...
        const response = await node_fetch_1.default("https://www.youtube.com/o/oauth2/device/code", {
            method: "POST",
            headers: {
    ...
    static async authenticate(code) {
        ...
        const response = await node_fetch_1.default("https://www.youtube.com/o/oauth2/token", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                __youtube_oauth__: "True",
